...
public class FirstUnique {
    ...
    LinkedHashSet<Integer> uniqueSet; // LinkedHashSet is ordered
    Set<Integer> removedStuff;
    public FirstUnique(int[] nums) {
        uniqueSet = new LinkedHashSet<>();
        removedStuff = new HashSet<>();
        if(nums.length > 0){
    ...
    public int showFirstUnique() {
        //get an iterator
        Iterator<Integer> itr = uniqueSet.iterator();
    ...
    public void add(int value) {
        if(uniqueSet.contains(value)){
            ...
            removedStuff.add(value);
        }else {
            if(!removedStuff.contains(value)){
                uniqueSet.add(value);
            }
        }
    }
